...
set(CPACK_GENERATOR "TGZ;ZIP") # "NSIS;CygwinBinary;PackageMaker;DragNDrop"
set(PACKAGE_SOURCE_GENERATOR "TGZ;ZIP")
if(WIN32)
	list(APPEND CPACK_GENERATOR NSIS NSIS64)
elseif(APPLE)
	list(APPEND CPACK_GENERATOR Bundle OSXX11 DragNDrop)
else()
...
set(CPACK_BUNDLE_STARTUP_COMMAND masterminsdl)

if(APPLE)
	install(FILES extra/logo.icns)
	install(TARGETS mastermindsdl DESTINATION ../MacOS/)
endif(APPLE)
set(CPACK_PACKAGE_FILE_NAME mastermindsdl)
set(CPACK_APPLE_GUI_INFO_STRING ${CPACK_PACKAGE_DESCRIPTION_SUMMARY})
set(CPACK_APPLE_GUI_ICON icons/mastermind.png)
